...
const UI = {
  ...
  showcaseTeaserLabel: { nl: 'AI-GEGENEREERD WERK', en: 'AI-GENERATED WORK', id: 'KARYA BERBASIS AI' },
  showcaseTeaserTitle: { nl: 'Zie wat er mogelijk is met Creative AI Partner', en: "See what's possible with Creative AI Partner", id: 'Lihat apa yang bisa dihasilkan Creative AI Partner' },
  showcaseTeaserNote: { nl: '61 echte AI-gegenereerde beelden en video\'s uit het platform dat ik heb gebouwd — elke ratio, ongecropt.', en: '61 real AI-generated images and videos from the platform I built — every ratio, uncropped.', id: '61 gambar dan video AI asli dari platform yang saya bangun — setiap rasio, tanpa crop.' },
  ...
  showcasePageTitle: { nl: 'AI-gegenereerd werk', en: 'AI-Generated Work', id: 'Karya Berbasis AI' },
  showcasePageNote: {
    nl: 'Beeld- en videocreaties gemaakt met Creative AI Partner, het AI-productieplatform dat ik heb gebouwd — elke ratio, ongecropt.',
    en: 'Image and video creations made with Creative AI Partner, the AI production platform I built — every ratio, uncropped.',
    id: 'Kreasi gambar dan video yang dibuat dengan Creative AI Partner, platform produksi AI yang saya bangun — setiap rasio, tanpa crop.',
  },
  ...
  showcaseBadgeVideo: { nl: 'AI VIDEO', en: 'AI VIDEO', id: 'AI VIDEO' },
  showcaseBadgeImage: { nl: 'AI BEELD', en: 'AI IMAGE', id: 'AI GAMBAR' },
